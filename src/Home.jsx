    ...
    <>
      ...
      >
        ...
        <Tab eventKey={enumTabPane.HELP} title="ヘルプ" className="mx-2 mt-2">
          ...
          <p>
            このアプリは<b>アルファ版</b>
            です。不具合が多いかもしれません。また、予告なく開発停止や公開停止をする可能性があります。
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              作成したデッキレシピで手札と魔力ゾーンのシミュレーションが可能
            </li>
          </ul>
          <h2>操作方法</h2>
          <h3>カードタブ</h3>
          <p>
            各カードのプラス、マイナスボタンでメインデッキおよび魔力デッキの枚数を増減できます。カード名やルールテキストを入力してカードの検索ができます。「条件で絞り込む」を開くとエキスパンション、レアリティ、色、種類とAP/HP、レベルでカードの絞り込みができます。
          </p>
          <Alert variant="info">
            カード名のみ読み仮名のひらがなでも検索できます。ただしルールテキストを検索したい場合は文字通りに入力してください。
          </Alert>
          <Alert variant="info">
            検索はルールテキスト全体を探します。ただし「◆」の文字は存在しないものとして扱います。
          </Alert>
          <h3>レシピタブ</h3>
          <p>
            カードの下部をタップする
            (パソコンではカードの上にマウスカーソルを当てる)
            と、そのカードに重なるボタンが現れます。各ボタンで枚数の増減やカード画像のズームができます。
          </p>
          <p>
          ...
          <p>
            灰色の手札はデッキからドローするカードです。タップ (PCではクリック)
